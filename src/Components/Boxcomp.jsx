...
const Boxcomp = ({text, value,img,onClick}) => {
  ...
  return (
    <div onClick={onClick} className={`flex gap-2 text-center ${Theme==="dark"?"bg-gray-800 text-amber-50 border-none":"bg-white text-black border-none"} text-xl flex p-10 border-1 rounded-2xl`}>
